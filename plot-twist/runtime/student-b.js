(function(){
  ...
  function brand(){return window.GAME_B_BRAND;}
  ...
  window.addEventListener('enginesave',event=>{
    ...
    if(d.state==='saved')el.innerHTML='✓ Result saved. <span>Look up for the class podium.</span>'+(E.preview?' <a target="_blank" rel="noopener" href="host.html?code='+encodeURIComponent(d.key.split(':')[0])+'">Open podium host ↗</a>':'');
    if(d.state==='pending'){
